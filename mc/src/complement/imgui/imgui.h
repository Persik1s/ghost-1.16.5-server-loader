...
struct ImVec2
{
    ...
    ImVec2 operator+ (int size) const {
        return ImVec2(this->x + size,this->y + size);
    }
    ImVec2 operator+ (ImVec2 vec) const {
        return ImVec2(this->x + vec.x,this->y + vec.y);
    }
...
namespace ImGui
{
    ...
    IMGUI_API void          BlockStart(const char* lable,ImVec2 size,ImFont* font);
    IMGUI_API void          BlockEnd();

    IMGUI_API void          DrawBox(const char* lable,ImVec2 size,ImColor color,float round) ;
    // Windows Utilities
    ...
    IMGUI_API bool          Checkbox_Custom(const char* label, bool* v,ImFont* font);
    ...
    IMGUI_API bool          SliderScalarCustom(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags);
    IMGUI_API bool          SliderFloatCustom(const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags);
